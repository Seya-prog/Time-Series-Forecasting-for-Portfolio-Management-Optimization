...
class PortfolioOptimizer:
    ...
    def find_optimal_portfolios(self):
        ...
        max_sharpe_return, max_sharpe_vol, max_sharpe_ratio = (
            self.portfolio_performance(max_sharpe_weights)
        )
...
def main():
    ...
    try:
        ...
        try:
            ...
            with open(
                "results/tesla_arima_forecast_report.txt", "r", encoding="utf-8"
            ) as f:
        ...
        print(
            "Efficient frontier plot saved as 'results/figures/efficient_frontier.png'"
        )
