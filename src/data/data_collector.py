...
class FinancialDataCollector:
    ...
    def fetch_data(
            self, symbols: Optional[List[str]] = None) -> Dict[str, pd.DataFrame]:
        """
    ...
    def save_data(self, output_dir: str = "data/raw") -> None:
        ...
        # Save combined data to processed folder (since it's derived/processed
        # data)
        if self.data:
            ...
            combined_filepath = os.path.join(
                processed_dir, "combined_historical_data.csv")
